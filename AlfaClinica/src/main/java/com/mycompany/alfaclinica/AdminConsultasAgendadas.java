 ...
 * @author letic
 */
public class AdminConsultasAgendadas extends javax.swing.JFrame {

    /**
     * Creates new form AdminConsultasAgendadas
     */
    public AdminConsultasAgendadas() {
        initComponents();
    ...
    public void consultarConsultas()throws Exception {
        ...
        String sql = "SELECT * FROM tb_consultas WHERE disponivel = false";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminConsultasAgendadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminConsultasAgendadas().setVisible(true);
            }
        });
    }
