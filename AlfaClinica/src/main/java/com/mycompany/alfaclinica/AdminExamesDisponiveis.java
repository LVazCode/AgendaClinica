 ...
 * @author letic
 */
public class AdminExamesDisponiveis extends javax.swing.JFrame {

    /**
     * Creates new form AdminExamesDisponiveis
     */
    public AdminExamesDisponiveis() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        AdminExcluirExame excluirExame = new AdminExcluirExame();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExamesDisponiveis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExamesDisponiveis().setVisible(true);
            }
        });
    }
